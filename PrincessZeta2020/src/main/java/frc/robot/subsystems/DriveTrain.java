...
public class DriveTrain extends Subsystem {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        // FIXME: You won't need these, unless you intend on setting it up so smartdashboard can change them.
...
*/
    ...
    public void periodic() {
        ...
        //FIXME: Put the following items on the dashboard
        // 1) turnPidController setpoint
        // 2) gyroTurnAngle
    ...
    public void drive(double leftSpeed, double rightSpeed) {
        ...
        // FIXME: Move the following 4 lines to a "public void driveRaw(double ls, double rs)"
    ...
    public void setTurnSetpoint(double angleInDegrees){
        //FIXME: Need to reset the PID controller
