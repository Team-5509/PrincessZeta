...
private WPI_TalonSRX shooterDrive2;
    ...
    public Shooter() {
        ...
        shooterDrive1 = new WPI_TalonSRX(8);    //Top Shooter
        shooterDrive2 = new WPI_TalonSRX(9);    //Bottom Shooter
    ...
    public void shoot(double rotationTop, double rotationBottom){
        this.setPercentSpeedPIDTop(rotationTop);
        this.setPercentSpeedPIDBottom(rotationBottom);
    }
