...
public JoystickButton limelightOnButton;
...
limelightOnButton = new JoystickButton(driverRightJoystick, 5);
limelightOnButton.whileHeld(new LimelightOn());
...
shiftHighButton.whenPressed(new ShiftHigh());
        ...
        SmartDashboard.putData("LimelightOn", new LimelightOn());
        SmartDashboard.putData("TurnNDegreesRelative: Turn45R", new TurnNDegreesRelative(45));
        SmartDashboard.putData("TurnNDegreesRelative: Turn45L", new TurnNDegreesRelative(-45));
        SmartDashboard.putData("TurnNDegreesRelative: Turn90R", new TurnNDegreesRelative(90));
        SmartDashboard.putData("TurnNDegreesRelative: Turn90L", new TurnNDegreesRelative(-90));
        SmartDashboard.putData("TurnNDegreesRelative: Turn60R", new TurnNDegreesRelative(60));
        SmartDashboard.putData("TurnNDegreesRelative: Turn60L", new TurnNDegreesRelative(-60));
        SmartDashboard.putData("TurnNDegreesRelative: Turn30R", new TurnNDegreesRelative(30));
        SmartDashboard.putData("TurnNDegreesRelative: Turn30L", new TurnNDegreesRelative(-30));
