...
indexButton.whileHeld(new Index(.5));
...
shiftHighButton.whenPressed(new ShiftHigh());
        ...
        SmartDashboard.putData("DriveXFeet: DriveTrain_Drive_10_feet", new DriveXFeet(5, .1));
        ...
        //SmartDashboard.putData("Index", new Index());
